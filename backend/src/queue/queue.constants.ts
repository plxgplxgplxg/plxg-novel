...
export const DEFAULT_BOOK_CHAPTER_CONCURRENCY = 2;
export const MIN_BOOK_CHAPTER_CONCURRENCY = 1;
export const MAX_BOOK_CHAPTER_CONCURRENCY = 4;

export const DEFAULT_TRANSLATION_CHUNK_SIZE = 800;
export const MIN_TRANSLATION_CHUNK_SIZE = 500;
export const MAX_TRANSLATION_CHUNK_SIZE = 1200;
export const LOW_FAILURE_TRANSLATION_CHUNK_SIZE = 1000;
export const HIGH_FAILURE_TRANSLATION_CHUNK_SIZE = 600;
export const CHUNK_FAILURE_RATE_SAMPLE_SIZE = 200;
